  ...
  return (
    <div className="space-y-6 animate-fadeInUp">
      ...
      <div className="apple-card p-10 text-center">
        ...
        <p className="text-sm text-[var(--text-secondary)] max-w-md mx-auto mb-5">Скоро: лицензионный договор, акт оказанных услуг, счета. Запрос закрывающих документов за период.</p>
